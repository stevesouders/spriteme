...
// from http://jqueryui.com/latest/ui/ui.core.js minified using YUI Compressor
...
// from http://jqueryui.com/latest/ui/ui.sortable.js minified using YUI Compressor
/*
...
SpriteMe.showSpritemePanel = function() {
	...
	sHtml = '<div style="float: right; text-align: right; margin-bottom: 4px; padding: 2px 0 2px 0; background: transparent;">' +
	...
	'&nbsp;&nbsp;<a class=spritemebuttonlink href="javascript:SpriteMe.toggleMin(1)" style="color: white;" title="minify the SpriteMe panel">min</a>' +
	'&nbsp;&nbsp;<a class=spritemebuttonlink href="javascript:SpriteMe.closeSpriteMe()" style="color: white;" title="remove the SpriteMe panel">close</a>' + 
	...
	'<a title="SpriteMe home" href="http://spriteme.org/" target="_blank" style="background: #F1E7F1;"><img src="http://spriteme.org/images/logo-16x16.png" border=0 width=16 height=16></a>' +
	...
	spritemepanel.style.cssText = 
	    "position: absolute; right: 10px; top: 40px; width: 400px; border: 2px solid #000; padding: 8px; z-index: 12800; background: #F1E7F1;";
...
SpriteMe.dprint = function(level, msg) {
	if ( level <= SpriteMe.dprintLevel ) {
		if ( "undefined" !== typeof(console) && "undefined" != typeof(console.log) ) {
			...
			if ( "undefined" === typeof(SpriteMe.bDprintAlert) ) {
				SpriteMe.bDprintAlert = confirm("There is no console for printing debug messages. Do you want them to appear in alert dialogs?");
			}

			if ( SpriteMe.bDprintAlert ) {
				alert(msg);
			}
		}
	}
